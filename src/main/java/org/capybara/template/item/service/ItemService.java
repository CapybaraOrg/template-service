package org.capybara.template.item.service;

import org.capybara.template.item.domain.jpa.ItemEntity;
import org.capybara.template.item.model.ItemModel;
import org.capybara.template.item.repository.jpa.ItemRepository;
